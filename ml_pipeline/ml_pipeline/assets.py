...
from dagster import multi_asset, AssetOut, AssetExecutionContext, get_dagster_logger
...
def hackernews_stories():
    """Get the current 1000 top stories
    """
...
@asset
def comments_model_test_set_r_squared(context: AssetExecutionContext, transformed_test_data, xgboost_comments_model):
